...
class AppThemeData {
  ...
  static ThemeData lightTheme() => ThemeData(
        ...
        bottomNavigationBarTheme: const BottomNavigationBarThemeData(
            selectedItemColor: Color.fromARGB(255, 47, 133, 255)),
  ...
  static ThemeData darkTheme() => ThemeData(
        ...
        textTheme: GoogleFonts.nunitoTextTheme().copyWith(
            titleLarge: const TextStyle(color: Color.fromARGB(255, 255, 255, 255), fontSize: 28),
            titleMedium:
                const TextStyle(color: Color.fromARGB(255, 147, 144, 144), fontSize: 28),
            bodyMedium: const TextStyle(color: Colors.white, fontSize: 28),
            titleSmall:
                const TextStyle(color: Color.fromARGB(255, 185, 182, 182), fontSize: 22)),
